package com.kekegdsz.imagepicker.utils;
...
public class StringUtils {
    ...
    public static void tempTextFont(TextView tv, int mimeType) {
        ...
        String str = mimeType == ImageMimeType.ofAudio() ?
                tv.getContext().getString(R.string.image_empty_audio_title)
                : tv.getContext().getString(R.string.image_empty_title);
