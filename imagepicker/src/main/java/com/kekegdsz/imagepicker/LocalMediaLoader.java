...
public class LocalMediaLoader {
    ...
    private int type = ImageConfig.TYPE_IMAGE;
                            ...
                            if (data != null) {
                                ...
                                if (count > 0) {
                                    ...
                                    if (latelyImages.size() > 0) {
                                        ...
                                        String title = type == ImageMimeType.ofAudio() ?
                                                activity.getString(R.string.image_all_audio)
                                                : activity.getString(R.string.image_camera_roll);
