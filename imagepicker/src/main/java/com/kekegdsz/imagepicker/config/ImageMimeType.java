package com.kekegdsz.imagepicker.config;
...
public final class ImageMimeType {
    public static int ofAll() {
        return ImageConfig.TYPE_ALL;
    }

    public static int ofImage() {
        return ImageConfig.TYPE_IMAGE;
    }

    public static int ofVideo() {
        return ImageConfig.TYPE_VIDEO;
    }

    public static int ofAudio() {
        return ImageConfig.TYPE_AUDIO;
    }
    ...
    public static String s(Context context, int mediaMimeType) {
        ...
        switch (mediaMimeType) {
            case ImageConfig.TYPE_IMAGE:
                return ctx.getString(R.string.image_error);
            case ImageConfig.TYPE_VIDEO:
                return ctx.getString(R.string.image_video_error);
            case ImageConfig.TYPE_AUDIO:
                return ctx.getString(R.string.image_audio_error);
            default:
                return ctx.getString(R.string.image_error);
        }
    }
